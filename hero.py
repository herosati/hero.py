...
for student in (students):
    ...
    records = {student_id: (student_name, student_score)}

    if student_score >= 70:

        high_performance.append(records)

    elif student_score >= 50 and student_score < 70:

        average_performance.append(records)

    else:

        low_performance.append(records)
